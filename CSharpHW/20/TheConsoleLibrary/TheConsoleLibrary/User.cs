...
namespace TheConsoleLibrary
{
    ...
    public class User : IUser
    {
        ...
        public bool CompareLogin(User anotherUser)
        {
            if (NameGiven)
            {
                if (anotherUser.Name == Name)
                {
                    return true;
                }
                else
            ...
            {
                if (anotherUser.Email == Email)
                    return true;
                return false;
            }
        }

        public bool ComparePassword(User anotherUser)
        {
            if (anotherUser.Password == Password)
                return true;
            return false;
        }
    }
